        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReorderThreshold = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_KitchenInventoryItems", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MealType = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: false),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Form = table.Column<string>(type: "nvarchar(80)", maxLength: 80, nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                    UpdatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OperatingSummaries", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ResidentDietPlans", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ResidentDietPlans_DietPlans_DietPlanId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MealDistributions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MealDistributions_Meals_MealId",
                        column: x => x.MealId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MedicineShelves", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MedicineShelves_Medicines_MedicineId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ResidentMedicines", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ResidentMedicines_Medicines_MedicineId",
                        column: x => x.MedicineId,
                        principalTable: "Medicines",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ResidentDocuments_Residents_ResidentId",
                        column: x => x.ResidentId,
                        principalTable: "Residents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "ResidentMedicalProfiles",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ResidentId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    BloodType = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AllergiesSummary = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ChronicConditionsSummary = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Notes = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UpdatedAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ResidentMedicalProfiles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ResidentMedicalProfiles_Residents_ResidentId",
                        column: x => x.ResidentId,
                        principalTable: "Residents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MedicineSchedules_ResidentMedicines_ResidentMedicineId",
            ...
            migrationBuilder.CreateTable(
                name: "DoseAdministrations",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    MedicineScheduleId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    DoseDate = table.Column<DateOnly>(type: "date", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    AdministeredAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DoseAdministrations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DoseAdministrations_MedicineSchedules_MedicineScheduleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DoseAdministrations_MedicineScheduleId",
                table: "DoseAdministrations",
                column: "MedicineScheduleId");

            migrationBuilder.CreateIndex(
                name: "IX_MealDistributions_MealId",
                table: "MealDistributions",
                column: "MealId");

            migrationBuilder.CreateIndex(
                name: "IX_Medicines_TenantId_Name_Strength",
                table: "Medicines",
                columns: new[] { "TenantId", "Name", "Strength" });

            migrationBuilder.CreateIndex(
                name: "IX_MedicineSchedules_ResidentMedicineId",
                table: "MedicineSchedules",
                column: "ResidentMedicineId");

            migrationBuilder.CreateIndex(
                name: "IX_MedicineShelves_MedicineId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ResidentDietPlans_DietPlanId",
                table: "ResidentDietPlans",
                column: "DietPlanId");

            migrationBuilder.CreateIndex(
                name: "IX_ResidentDocuments_ResidentId",
                table: "ResidentDocuments",
                column: "ResidentId");

            migrationBuilder.CreateIndex(
                name: "IX_ResidentMedicalProfiles_ResidentId",
                table: "ResidentMedicalProfiles",
                column: "ResidentId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ResidentMedicines_MedicineId",
                table: "ResidentMedicines",
                column: "MedicineId");

            migrationBuilder.CreateIndex(
                name: "IX_Residents_TenantId_Code",
                table: "Residents",
